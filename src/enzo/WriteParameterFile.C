...
int WriteParameterFile(FILE *fptr, TopGridData &MetaData, char *name = NULL)
{
  ...
  fprintf(fptr, "AGNParticleBondiRadiusKpc             = %"GSYM"\n", AGNParticleBondiRadiusKpc); //added by DP for bondi in addition to cold-mode
  ...
  fprintf(fptr, "AGNParticleBondiAccretion             = %"ISYM"\n", AGNParticleBondiAccretion);//added by DP to account for BA in addition to cold  mode acc.
  ...
  fprintf(fptr, "ClusterSphereC200            = %"FSYM"\n", ClusterSphereC200);
  fprintf(fptr, "ClusterBCGRho0               = %"FSYM"\n", ClusterBCGRho0);
  fprintf(fptr, "ClusterBCGA0                 = %"FSYM"\n", ClusterBCGA0);
  fprintf(fptr, "ClusterBaryonK0              = %"FSYM"\n", ClusterBaryonK0);
  fprintf(fptr, "ClusterBaryonK100            = %"FSYM"\n", ClusterBaryonK100);
  fprintf(fptr, "ClusterBaryonAlphaK          = %"FSYM"\n", ClusterBaryonAlphaK);
