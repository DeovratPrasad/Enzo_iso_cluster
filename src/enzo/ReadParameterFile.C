...
/* FDM: read FDM parameters */
    ...
    ret += sscanf(line, "AGNParticleBondiRadiusKpc = %"FSYM, &AGNParticleBondiRadiusKpc); //added by DP for Bondi in addition to cold-mode
    ...
    ret += sscanf(line, "AGNParticleBondiAccretion = %"ISYM, &AGNParticleBondiAccretion); //Added by DP to account for BA in addition to Cold mode accretion.
